const icons: Record<string, React.ReactNode> = {
  tree: (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="#0076df">
  ...
  web: (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="#0076df">
      ...
      <line x1="8" y1="7" x2="10.5" y2="10.5" stroke="#0076df" strokeWidth="1.5" />
      <line x1="16" y1="7" x2="13.5" y2="10.5" stroke="#0076df" strokeWidth="1.5" />
      <line x1="8" y1="17" x2="10.5" y2="13.5" stroke="#0076df" strokeWidth="1.5" />
      <line x1="16" y1="17" x2="13.5" y2="13.5" stroke="#0076df" strokeWidth="1.5" />
    </svg>
  ),
  search: (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="#0076df">
